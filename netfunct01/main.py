#!/usr/bin/env python3
""" Alta3 Research || Author: kevin.kash@tlgcohort.com """

# function to push commands
def commandpush(devicecmd): # deviceme == dict

    for ip in devicecmd.keys(): #looping through the dict
        print(f'Handshaking. .. ... connecting with {ip}') #fstring
        # we'll learn to write code that connects wto devices here
        for mycmds in devicecmd[ip]:
            print(f'Attemping to sending command --> {mycmds}')
